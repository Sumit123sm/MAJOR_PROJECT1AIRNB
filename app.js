...
const ejsMate=require("ejs-mate"); // For using ejs as template engine
...
app.engine("ejs",ejsMate); // For using ejs as template engine
...
//         .then((res)=>console.log("listing was saved"))
//         .catch((err)=>console.log(err));
